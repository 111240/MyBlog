<template>
  <div class="pikachu">
    <div class="container pika" @mousedown="moveBox($event)" ref="pikachu">
      <div class="pika-head">
        <div class="pika-head-face">
      ...
      <div class="pika-body">
        <div class="pika-body-body"></div>
        <div class="pika-arm pika-arm-left"></div>
        <div class="pika-arm pika-arm-right"></div>
        <div class="pika-leg pika-leg-left"></div>
        <div class="pika-leg pika-leg-right"></div>
...
export default {
  ...
  methods: {
    moveBox(e){
      this.disX = e.clientX - this.$refs.pikachu.offsetLeft;
      this.disY = e.clientY - this.$refs.pikachu.offsetTop;
      document.onmousemove = event => {
        let left = event.clientX - this.disX;
        let top = event.clientY - this.disY;
        this.$refs.pikachu.style.left = left + 'px';
        this.$refs.pikachu.style.top = top + 'px';
      };
      document.onmouseup = () => {
